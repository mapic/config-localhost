module.exports = {
	"serverConfig": {
		...
		"port": 3001,
		"mongo": {
			"url": "mongodb://systemapic:[KEYS_MUST_MATCH_MONGO_CONFIG]@mongo/systemapic",
		},
		"redis": {
